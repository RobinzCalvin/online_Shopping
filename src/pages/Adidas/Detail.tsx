    ...
    <>
      <div className="flex flex-col">
        ...
        <div className="flex justify-center">
          <div className=" flex flex-col md:flex-row md:w-3/4 space-x-10 ">
            <div className=" md:w-[60%] flex flex-col items-center ">
              <div className="w-1/2 h-auto ">
                <img src="/img/shirts1.jpg" className="h-auto" alt="" />
              </div>
              ...
              <Accordion alwaysOpen={true} className=" w-full mt-4 p-10 border-none">
                <Accordion.Panel >
              ...
              <div className="flex flex-col pr-10 font-[Helvetica]">
                ...
                <div className="text-xl ">
                  ...
                  <div className=" w-full text-center">
                    <Link to={'/Bag'}>
                      <button className="w-3/5 mt-5 p-4 bg-black text-2xl text-white hover:text-gray-400">Add to Bag</button>
                    </Link>
                  </div>
